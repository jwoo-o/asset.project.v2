<template>
  <div class="app-container">
    <el-row v-if="!isView" type="flex" justify="center" style="margin: 10px">
      <el-col :xs="24" :sm="24" :lg="14">
        <el-card shadow="never" class="grid-wrapper">
          <el-row :gutter="20">
            <el-col :xs="10" :sm="5" :lg="3">
              <el-select
    ...
    <el-row v-else type="flex" justify="center">
      <el-col :xs="24" :sm="24" :lg="14">
        <el-card shadow="never" class="grid-wrapper" :body-style="{padding:20}">
          <div class="content">
            <el-row>
