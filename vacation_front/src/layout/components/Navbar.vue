  ...
  <div class="navbar">
    <el-col :xs="22" :sm="19" :lg="20">
      ...
      >
        ...
        <el-menu-item v-if="$store.getters.jobCd > '2'" index="user-vac-list">
          휴가 현황
        </el-menu-item>
        <el-submenu v-if="$store.getters.isAssetAdmin || $store.getters.isAdmin" index="user-asset-dashboard">
          <template slot="title">자산관리</template>
          <el-menu-item index="user-asset-dashboard">
            자산 현황
          </el-menu-item>
          <el-menu-item index="user-asset-list">
            자산 정보
          </el-menu-item>
        </el-submenu>
        <el-menu-item index="user-board-notice">
          공지 사항
        </el-menu-item>
        <el-menu-item index="user-seat-index">
          배치도
        </el-menu-item>
      </el-menu>
      <el-menu
